...
-   Observations are predicted for all grid cells based on the spatial <br> covariogram (or covariance matrix)

. . .

-   Average of all predictions in several grid cells lying in one county
